...
export function registerDocumentParseTool(pi: ExtensionAPI, executor: NativeExecutor): void {
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Pass PPTX and other supported Office documents directly. The isolated worker converts them to PDF before parsing; do not ask the user or model to run LibreOffice.",
